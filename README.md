...
A lightweight, self-hosted web app built with **PHP**, **vanilla JavaScript**, and **HTML** for storing and browsing AI prompts.  
Prompts are organized by **AI type** (e.g., ChatGPT, Suno, Midjourney) and **category**, and all data is saved as simple JSON files — no database or external dependencies required.
